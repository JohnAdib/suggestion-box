<template>
  <svg v-if="type == 'bug'" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
  ...
  <svg v-else-if="type == 'suggestion'" width="24" height="24" viewBox="0 0 24 24" fill="none"
...
<script lang="ts">
import type { FeedbackTypeTypes } from '@/interfaces/feedback-types';

export default defineComponent({
  props: {
    type: {
      type: String as PropType<FeedbackTypeTypes>,
    },
  },
})
</script>
